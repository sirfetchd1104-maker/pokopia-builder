const dict = {
  ko: {
    ...
    toast_selection_rotated: "블록 {0}개 회전",
    hint_select_rotate: "범위 회전",
    screenshot: "스크린샷",
    toast_screenshot_saved: "스크린샷을 저장했습니다.",
  ...
  en: {
    ...
    shape_window: "Window",
    shape_slopedWindow: "Sloped Window",
    shape_arch: "Arch",
    shape_stair: "Stairs",
    shape_ladder: "Ladder",
    shape_rope: "Rope",
    ...
    toast_selection_rotated: "Rotated {0} block(s)",
    hint_select_rotate: "Rotate Selection",
  ...
  ja: {
    ...
    toast_selection_rotated: "ブロック{0}個を回転",
    hint_select_rotate: "範囲回転",
